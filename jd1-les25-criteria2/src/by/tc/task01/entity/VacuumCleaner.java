...
public class VacuumCleaner extends Appliance {
	...
	public VacuumCleaner(String title, int powerConsumption, String filterType, String wandType,
			int motorSpeedRegulation, int cleaningWidth, String bagType) {
		super(title);
	...
	public String toString() {
		return "VacuumCleaner [powerConsumption=" + powerConsumption + ", filterType=" + filterType + ", wandType="
